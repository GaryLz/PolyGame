...
# -----------------------------------------------------------------------------
ABOUT = ['Polygon Game: {0}'.format("School Project 2020"),
		'', # new line
		'Author: {0}'.format("Algorithm TEAM #9"),
		 'School: {0}'.format("Shantou Univerisity")]
DIFFICULTY = ['EASY']
FPS = 60.0
WINDOW_SIZE = (640, 480)
...
def play_function(difficulty, font, test=False):
	...
	#for-debugging: 判断是不是所需要的type，否则raise valueError
